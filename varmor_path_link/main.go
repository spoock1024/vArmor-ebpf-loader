...
func main() {
	...
	prog := coll.Programs["varmor_path_link"]
	if prog == nil {
	...
	if err != nil {
		log.Fatalf("failed to attach varmor_path_link program: %v", err)
	}
	fmt.Println("successfully attached varmor_path_link program")
